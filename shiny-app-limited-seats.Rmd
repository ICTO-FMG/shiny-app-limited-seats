...
students <- eventReactive(input$submit_button, {(input$student_data)})
  ...
  results <- eventReactive(input$submit_button, {
    ...
    if(N_students > N_spots) {
      ...
      studnr_already_in_last_lecture <- students_vector[(N_students-filled_students_last_lecture+1):N_students] # laatste 48 uit students_vector weghalen
      
      remaining_students_to_sample_from <- students_vector[!students_vector %in% studnr_already_in_last_lecture] 
      # haal studnr_already_in_last_lecture uit students_vector en doe dan daarmee remaining_sport_sample
