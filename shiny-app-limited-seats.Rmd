...
Use the Microsoft forms template below to have students register for on campus lectures prior to the start of your course. Just hit the duplicate button on the top right to use it for yourself, and use the template text from the tab obove.
